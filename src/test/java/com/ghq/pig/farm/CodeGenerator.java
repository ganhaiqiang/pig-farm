...
public class CodeGenerator {
	...
	public static void main(String[] args) {
		...
		dsc.setUrl("jdbc:mysql://localhost:3306/pig-farm?serverTimezone=UTC");
...
//                        + "/" + tableInfo.getEntityName() + "Mapper" + StringPool.DOT_XML;
				...
				return projectPath + "/src/main/java/com/ghq/pig/farm/"+pc.getModuleName()+"/mapper/xml/" + tableInfo.getEntityName() + "Mapper" + StringPool.DOT_XML;
			}
		});
		/*
